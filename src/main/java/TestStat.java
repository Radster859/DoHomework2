 ...
 * @author deng_875452
 */
public class TestStat extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        statistics1.siteBlocked("google.com");
        statistics1.appBlocked("chrome.exe");
        JOptionPane.showMessageDialog(this, statistics1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestStat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
